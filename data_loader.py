...
from facedataset import FaceDataLoader

def get_loader(opts):
    train_set = FaceDataLoader(opts.root_dataset, opts, split='train')
    val_set = FaceDataLoader(opts.root_dataset, opts, split='test')
